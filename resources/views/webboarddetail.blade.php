...
<script type="text/javascript" src="../js/topicsdetail.js" charset="utf-8"></script>
...
<section id="intro" class="parallax-section">
	...
	<div class="container" >
	  ...
	  <a href="#" class="list-group-item ">
	    <h4 class="list-group-item-heading">{{$data->Topics}}</h4>
...
<div class="list-group">
<a href="#" class="list-group-item ">
	<h4 class="list-group-item-heading">	{{Session::get('firstname')." ".Session::get('lastname')}}</h4>
<input type="text" class="hidden" name="" id="id" value="{{$data->idboard}}">

<input type="text" class="form-control" name="" value="" id="textans">

<div id = "pp"> <button type="button" name="button" id="btn">ตกลง</button> </div>
</a>
</div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modaltopic">
	<div class="modal-dialog modal-lg">
      ...
      <input class="form-control"  type="text" name="" value="" id="texttop">
			<textarea class="form-control" aria-label="With textarea" id="textdetail"></textarea>
       </div>
       <div class="modal-footer">
         <button type="button"  data-dismiss="modal">Close</button>
         <button type="button" id="addddd" >Save changes</button>
       </div>
		</div>
	</div>
</div>
